...
# Only has robes and spear animations
...
class NPC_Man():
    ...
    def hit(self):
         if self.health > 0:
             ...
             self.ani_count += 1
             if self.ani_count < 5:
                 print(self.ani_count)
                 # win.blit(self.dead[self.ani_count], (self.CameraX , self.CameraY ))
             else:
                # win.blit(self.dead[4], (self.CameraX , self.CameraY ))
                print(self.ani_count)
         elif self.health <= 0:
             self.ani_count += 1
             ...
             self.isdown = False
             self.action = False
             #win.blit(self.dead[self.ani_count], (self.x - self.CameraX, self.y - self.CameraY))
    ...
    def draw(self, win):
        ...
        if self.isdead:
            win.blit(self.dead[4], (self.x, self.y))
